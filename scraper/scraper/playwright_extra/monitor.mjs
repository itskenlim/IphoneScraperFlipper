...
async function recheckOne(page, candidate, opts, index, total) {
  ...
  try {
    ...
    return {
      ...
      listing_seller_name: networkRow?.listing_seller_name ?? null,
      listing_category_name: networkRow?.listing_category_name ?? null,
      listing_leaf_category_name: networkRow?.listing_leaf_category_name ?? null,
      listing_taxonomy_name: networkRow?.listing_taxonomy_name ?? null,
